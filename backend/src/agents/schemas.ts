...
export const edgeTool: Anthropic.Tool = {
  name: 'draw_edges',
...
export const deduplicationTool: Anthropic.Tool = {
...
export const queryTool: Anthropic.Tool = {
  name: 'answer_query',
...
export const lintTool: Anthropic.Tool = {
